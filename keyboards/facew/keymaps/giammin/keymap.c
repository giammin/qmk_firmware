...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
        ...
        KC_LALT, KC_LGUI, KC_LCTL,                            KC_SPC,                             KC_RCTL, KC_RGUI, MO(2),   KC_RALT),
	...
	[2] = LAYOUT(
        ...
        KC_CAPS, KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT, _______, KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_INS,  KC_PSCR, _______, _______,
        _______, KC_VOLD, KC_VOLU, KC_MUTE, _______, _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, KC_DEL,           _______,
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, MO(3),
